...
from .views import HomeView, StudentCreateView, StudentDeleteView, StudentDetailView, StudentListView, StudentUpdateView,student_list, home, student_add, student_detail, student_update,student_delete
